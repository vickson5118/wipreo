<c:if test="${!empty requestScope.listeCoupsCoeur}">

	<div class="carrousel-coups-coeur">
	<p>Nos coups de coeur</p>
	
	<div class="row slider-top-formations">
		<c:forEach items="${requestScope.listeCoupsCoeur}" var="formation">
