...
import com.wipreo.validation.FacebookConnexionValidation;

@WebServlet("/facebook-connexion")
public class FacebookConnexion extends HttpServlet {
	...
	public void doPost(final HttpServletRequest request, final HttpServletResponse response)
		...
		final FacebookConnexionValidation validation = new FacebookConnexionValidation(this.utilisateurDao);
		final Utilisateur utilisateur = validation.validFacebookConnexion(request);
