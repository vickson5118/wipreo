...
import com.wipreo.validation.RedefinirPasswordValidation;

@WebServlet(urlPatterns = "/compte/redefine-password")
public class RedefinirPassword extends HttpServlet {
	...
	public void doPost(final HttpServletRequest request, final HttpServletResponse response)
		...
		final RedefinirPasswordValidation validation = new RedefinirPasswordValidation(this.utilisateurDao);
		final boolean reponse = validation.validRedefinirPassword(request);
