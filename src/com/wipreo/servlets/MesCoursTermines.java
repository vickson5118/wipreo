...
@WebServlet(urlPatterns = "/espace-client/mes-cours-termines")
public class MesCoursTermines extends HttpServlet {

	private final String GET = "/WEB-INF/components/espace-client/mes-cours-termines.jsp";
	private final String ATT_LISTE_COURS_TERMINES = "listeCoursTermines";
	...
	public void doGet(final HttpServletRequest request, final HttpServletResponse response)
		...
		final List<Achat> listeCoursTermines = this.achatDao.getAllUserFormationPaidFinish(utilisateurId);

		request.setAttribute(this.ATT_LISTE_COURS_TERMINES, listeCoursTermines);
