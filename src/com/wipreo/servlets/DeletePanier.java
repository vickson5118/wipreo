...
import com.wipreo.validation.DeletePanierValidation;

@WebServlet("/delete-panier")
public class DeletePanier extends HttpServlet {
	...
	public void doPost(final HttpServletRequest request, final HttpServletResponse response)
		...
		final DeletePanierValidation validation = new DeletePanierValidation(this.achatDao);
		final boolean reponse = validation.validDeletePanier(request);
