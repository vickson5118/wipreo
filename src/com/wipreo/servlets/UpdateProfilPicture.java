...
import com.wipreo.validation.UpdateProfilPictureValidation;

@WebServlet("/update-profil-picture")
@MultipartConfig(location = Constants.TEMP_DIRECTORY, fileSizeThreshold = 1000000, maxFileSize = 15000000, maxRequestSize = 15000000)
public class UpdateProfilPicture extends HttpServlet {
	...
	public void doPost(final HttpServletRequest request, final HttpServletResponse response)
		...
		final UpdateProfilPictureValidation validation = new UpdateProfilPictureValidation(this.utilisateurDao);
		final boolean reponse = validation.validUpdateProfilPicture(request);
