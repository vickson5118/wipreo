...
import com.wipreo.validation.AddObjectifPreferenceValidation;

@WebServlet("/add-objectif")
public class AddObjectifPreference extends HttpServlet {
	...
	public void doPost(final HttpServletRequest request, final HttpServletResponse response)
		...
		final AddObjectifPreferenceValidation validation = new AddObjectifPreferenceValidation(this.utilisateurDao);
		final boolean reponse = validation.validAddObjectif(request);
