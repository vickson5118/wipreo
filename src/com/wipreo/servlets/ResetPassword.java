...
import com.wipreo.validation.ResetPasswordValidation;

@WebServlet(urlPatterns = "/compte/reset-password")
public class ResetPassword extends HttpServlet {
	...
	public void doPost(final HttpServletRequest request, final HttpServletResponse response)
		...
		final ResetPasswordValidation validation = new ResetPasswordValidation(this.utilisateurDao);
		final boolean reponse = validation.validResetPassword(request);
